...
namespace NBD.Controllers
{
	public class HomeController : Controller
	{
        ...
        public async Task<IActionResult> AttachImage(string id)
        {
            ...
            var imageData = await _computerService.GetImage(computer.ImageId); // Pobranie danych obrazu
            var base64Image = Convert.ToBase64String(imageData); // Konwersja na format base64
